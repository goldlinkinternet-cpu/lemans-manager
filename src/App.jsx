  ...
  return (
    <div style={S.app}>
      ...
      <header style={S.header}>
        <img src="/logo.jpg" alt="Stormline Team" style={{ height: 160, objectFit: "contain", mixBlendMode: "screen", filter: "brightness(1.4) saturate(1.3) drop-shadow(0 0 30px #39FF14cc)" }} />
